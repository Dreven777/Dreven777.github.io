...
/*const counterFactory = {
    count: 0,
    value: function(n){
        if(typeof n === 'number') this.count = n;
        return this.count;
    },
    increment: function(){
        this.count++;
...
console.log('counterFactory', counterFactory.value()) // 0
counterFactory.increment()
counterFactory.increment()
counterFactory.increment()
console.log('counterFactory', counterFactory.value()) // 3
counterFactory.decrement()
counterFactory.decrement()
console.log('counterFactory', counterFactory.value()) // 1
console.log('counterFactory', counterFactory.value(100)) // 100
counterFactory.decrement()
console.log('counterFactory', counterFactory.value()) // 99
console.log('counterFactory', counterFactory.value(200)) // 200
counterFactory.increment()
console.log('counterFactory', counterFactory.value()) // 201
...
console.log('myPow', myPow(2, 3, myPrint)) // 2^3=8
console.log('myPow', myPow(2, 0, myPrint)) // 2^0=1
console.log('myPow', myPow(2, -2, myPrint)) // 2^-2=0.25
